...
class PeriodicByCompanyGrid extends React.Component {
    constructor(props) {
        super(props);
        ...
        let source =
        {
            ...
            localdata: [
                ['Kronos', '01/01/2018', '01/01/2018', 'kronos', '23', '40','34','45','posted'],
                ['Kronos', '01/01/2018', '01/01/2018', 'kronos', '23', '40','34','45','posted'],
                ['Kronos', '01/01/2018', '01/01/2018', 'kronos', '23', '40','34','45','posted']
            ],
        };
    ...
    render() {
        ...
        [
         ...
         return (
            ...
            <label >Periodic Company Data by checkDate through 01/01/2018 to 01/03/2018</label>
...
export default PeriodicByCompanyGrid;